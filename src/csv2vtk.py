...
# 调用示例（路径相对仓库根，输出到 data/derived/legacy/）
if __name__ == "__main__":
    import os
    _REPO = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    _LEGACY = os.path.join(_REPO, "data", "derived", "legacy")
    csv_to_structured_vtk(os.path.join(_LEGACY, "inverted_M_results_test.csv"),
                          os.path.join(_LEGACY, "M_structured_test.vtk"))
